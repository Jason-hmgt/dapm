...
namespace ToyStore.Models
{
	...
	public partial class ToyStoreDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertAdCover(AdCover instance);
    partial void UpdateAdCover(AdCover instance);
    partial void DeleteAdCover(AdCover instance);
    ...
    partial void DeleteSanPham(SanPham instance);
		...
		public ToyStoreDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["QLHangHoa"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public ToyStoreDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ToyStoreDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ToyStoreDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ToyStoreDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<AdCover> AdCovers
		{
			get
			{
				return this.GetTable<AdCover>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AdCover")]
	public partial class AdCover : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnMaDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DongSP_AdCover", Storage="_DongSP", ThisKey="MaD", OtherKey="MaD", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._DongSP.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.AdCovers.Remove(this);
					}
					this._DongSP.Entity = value;
					if ((value != null))
					{
						value.AdCovers.Add(this);
						this._MaD = value.MaD;
					}
					else
					{
	...
	public partial class DongSP : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AdCover> _AdCovers;
    ...
    partial void OnTenDongChanged();
		...
		public DongSP()
		{
			this._AdCovers = new EntitySet<AdCover>(new Action<AdCover>(this.attach_AdCovers), new Action<AdCover>(this.detach_AdCovers));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DongSP_AdCover", Storage="_AdCovers", ThisKey="MaD", OtherKey="MaD")]
		public EntitySet<AdCover> AdCovers
		{
			get
			{
				return this._AdCovers;
			}
			set
			{
				this._AdCovers.Assign(value);
			}
		}
		...
		private void attach_AdCovers(AdCover entity)
		{
			this.SendPropertyChanging();
			entity.DongSP = this;
		}
		
		private void detach_AdCovers(AdCover entity)
		{
			this.SendPropertyChanging();
			entity.DongSP = null;
		}
    ...
    partial void OnimgChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_HinhAnh_SP", Storage="_SanPham", ThisKey="product_id", OtherKey="MaSP", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
    ...
    partial void OnMaPLChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_HinhAnh_SP", Storage="_HinhAnh_SPs", ThisKey="MaSP", OtherKey="product_id")]
